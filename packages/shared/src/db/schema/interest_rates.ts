...
export const interestRatesTable = pgTable(
  "interest_rates",
  {
  ...
  (table) => [
    index("idx_interest_rates_token").on(table.tokenAddress, table.actionType),
    index("idx_interest_rates_effective").on(table.effectiveDate),
  ],
);
