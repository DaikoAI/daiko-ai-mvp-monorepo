...
// --- Temporarily comment out push listeners for debugging ---
/*
...
self.addEventListener('push', (event: PushEvent) => {
  ...
  try {
    ...
    const options: NotificationOptions & { data: any } = {
      ...
      icon: data.icon || '/icons/icon-192x192.png', // デフォルトアイコン
      badge: data.badge || '/icons/icon-192x192.png', // バッジアイコン (Android)
      data: {
